...
if let farmAnimal = myFarm?.animals![randomNumber] as? Rat {
    farmAnimal.scurry()
} else if let farmAnimal = myFarm?.animals![randomNumber] as? GoldenDoodle {
    farmAnimal.romp()
} else if let farmAnimal = myFarm?.animals![randomNumber] as? Pig {
    farmAnimal.wallow()
}

if let cityAnimal = myApartment?.animals![randomNumber] as? Pigeon {
